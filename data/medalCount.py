...
with open('OlympicsWinter.csv') as csvfile: 
	...
	for row in reader:
		if line_count is 0:
			#parse that fist orw of text data out of the file
			categories.append(row)
			line_count +=1

		else: 
			if (row[0] == "1924") and (row[4] == "CAN"):
				print ("1924 metal for canada!")
				m_1924 += 1

			elif (row[0] == "1948") and (row[4] == "CAN"):
				print ("1948 metal for canada!")
				m_1948 += 1

			elif (row[0] == "1968") and (row[4] == "CAN"):
				print ("1968 metal for canada!")
				m_1968 += 1

			elif (row[0] == "1984") and (row[4] == "CAN"):
				print ("1984 metal for canada!")
				m_1984 += 1

			elif (row[0] == "2006") and (row[4] == "CAN"):
				print ("2006 metal for canada!")
				m_2006 += 1

			elif (row[0] == "2014") and (row[4] == "CAN"):
				print ("2014 metal for canada!")
				m_2014 += 1
